...
else() # Set the flags for ios.
  if(CC_TARGETS_ARM64)
    # iOS physical device.
    # The flags were set after running on an iPhone 6.
    set(PLATFORM_ACCEPTS_ABS_OVERLOAD 1)
    set(REALPATH_SUPPORTS_NONEXISTENT_FILES 0)
    set(SSCANF_SUPPORT_ll 1)
    set(SSCANF_CANNOT_HANDLE_MISSING_EXPONENT 0)
    set(HAVE_LARGE_SNPRINTF_SUPPORT 1)
    set(HAVE_BROKEN_FIFO_SELECT 1)
    set(HAVE_BROKEN_FIFO_KEVENT 1)
    set(HAVE_SCHED_GET_PRIORITY 1)
    ...
    set(UNGETC_NOT_RETURN_EOF 0)
    set(HAS_POSIX_SEMAPHORES 0)
    set(GETPWUID_R_SETS_ERRNO 0)
    set(FILE_OPS_CHECK_FERROR_OF_PREVIOUS_CALL 0)
  else()
    # iOS simulator
    set(PLATFORM_ACCEPTS_ABS_OVERLOAD 1)
    set(REALPATH_SUPPORTS_NONEXISTENT_FILES 0)
    ...
    set(SSCANF_CANNOT_HANDLE_MISSING_EXPONENT 0)
    set(HAVE_LARGE_SNPRINTF_SUPPORT 1)
    set(HAVE_BROKEN_FIFO_SELECT 0)
    set(HAVE_BROKEN_FIFO_KEVENT 0)
    set(HAVE_SCHED_GET_PRIORITY 1)
    set(HAVE_SCHED_GETCPU 0)
    set(HAVE_WORKING_GETTIMEOFDAY 1)
    set(HAVE_WORKING_CLOCK_GETTIME 1)
