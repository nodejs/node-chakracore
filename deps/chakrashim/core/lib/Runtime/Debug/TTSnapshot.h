...
namespace TTD
{
    ...
    public:
        ...
        void EmitSnapshot(const char16* sourceDir, DWORD snapId, ThreadContext* threadContext) const;

        //de-serialize the snapshot data
        static SnapShot* Parse(const char16* sourceDir, DWORD snapId, ThreadContext* threadContext);
