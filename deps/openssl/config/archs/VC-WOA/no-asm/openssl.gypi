{
  'variables': {
    ...
    'openssl_sources_VC-WOA': [
    ],
    'openssl_defines_VC-WOA': [
      'DSO_WIN32',
      'NDEBUG',
      'OPENSSL_THREADS',
  ...
  'defines': ['<@(openssl_defines_VC-WOA)'],

  'sources': ['<@(openssl_sources)', '<@(openssl_sources_VC-WOA)'],
}
